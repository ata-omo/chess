...
public:
    ...
    void GetNextMove(GamePiece* GameBoard[8][8]) {
        ...
        do {
            system ("clear");
            cout<<endl<<endl<<"          Welcome to Chess Game Developed by ASHISH RANJAN "<<endl<<endl<<endl;
